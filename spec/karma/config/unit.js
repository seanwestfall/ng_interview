...
module.exports = function (config) {
  ...
  var reporters = ['mocha', 'coverage', 'notify'];
  if (config.singleRun) {
    reporters = ['dots'];
  }
  ...
  config.set({
    ...
    files: [
      // 'spec/javascripts/angular/**/*_factory.js',
      APPLICATION_SPEC,
      'spec/javascripts/angular/controllers/*_spec.js',
      'spec/javascripts/angular/resources/*_spec.js',
